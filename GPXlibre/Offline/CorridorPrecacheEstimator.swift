...
enum CorridorPrecacheEstimator {
    static func estimate(for track: GPXTrack) -> PrecacheEstimate {
        ...
        for point in points {
            ...
            for zoom in OfflineConstants.corridorMinZoom...OfflineConstants.corridorMaxZoom {
                let tiles = TileCoordinate.tiles(minLat: box.minLat, maxLat: box.maxLat, minLon: box.minLon, maxLon: box.maxLon, zoom: zoom)
