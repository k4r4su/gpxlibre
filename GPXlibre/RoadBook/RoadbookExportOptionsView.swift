...
struct RoadbookExportOptionsView: View {
    ...
    /// Repères visibles en ligne dédiée — même liste que l'écran.
    var landmarkCheckpoints: [RoadbookLandmarkCheckpoint] = []
    ...
    private func generate() {
        let data = RoadbookPDFExporter.generate(trackName: trackName, maneuvers: maneuvers, landmarkCheckpoints: landmarkCheckpoints, options: options, landmarks: landmarks)
