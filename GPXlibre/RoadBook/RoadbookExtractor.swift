    ...
    static func maneuvers(
        ...
        return checkpoints.map { checkpoint in
            ...
            return RoadbookManeuver(
                ...
                headingDegrees: RoadbookAnalyzer.outgoingHeading(atCumulativeDistance: cumulative, points: track.points, cumulativeDistances: cumulativeDistances, windowAfterMeters: windowAfterMeters)
            )
        }
    }
}
